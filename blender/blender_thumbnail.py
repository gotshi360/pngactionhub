...
def show_dialog():
    ...
    dialog.add_text("Due to maintenance, GITEA is currently not functioning and files cannot be accessed from within Anchorpoint.")
    dialog.add_text("Please do not sync in Anchorpoint until the maintenance is over.")  
