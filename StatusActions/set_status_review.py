...
if __name__ == "__main__":
    ...
    if not ctx.project_id:
        ...
        if not user_ids:
            ...
            message = (
                f"👁️ <b>APPROVAL PENDING</b> — "
                f"A Review has been requested for '<font color='#dcc9f6'><b>{filename}</b></font>' from '<font color='#dcc9f6'><b>{project_name}</b></font>' "
                f"by <font color='#dcc9f6'><b>{username}</b></font>."
            )
